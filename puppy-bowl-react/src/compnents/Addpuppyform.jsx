...
try {
    ...
    // This is a way to show user a player was added. We are going to redirect right away so it might not show up.

   
    if (json.success) {
setSuccessMsg('A new player was successfully added')
} else {
    setSuccessMsg('There was an error adding new player')
}

navigate('/') // redirect us back to homepage
} catch (err) {
